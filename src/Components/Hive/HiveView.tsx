...
const HiveView: React.FC = ({ navigation }) => {
    ...
    const [starterWordState, setStarterWordState] = useState<string | null>(null);
        ...
        <Container>
            {hiveId ? (
                <>
                    ...
                    />
                    {userId === worstPlayer?.user_id && allCompleted && starterWordDate !== tomorrowDateString && (
                        <View>
                            <StarterWordInput
                     ...
                     {starterWordState && (
                            <View>
                                <MemberText>
                                    Starter Word for {starterWordDate}: {starterWordState}
                                </MemberText>
                            </View>
                        )}
                </>
